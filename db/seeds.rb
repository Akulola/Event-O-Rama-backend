...
attendee4 = Attendee.create(event: event1, user: user1, name: 'Ruth', surname: 'Osukuku', email: 'ruth@example.com')
attendee5 = Attendee.create(event: event1, user: user2, name: 'Kenneth', surname: 'Wachira', email: 'kenneth@example.com')
attendee6 = Attendee.create(event: event2, user: user1, name: 'Reagan', surname: 'Munene', email: 'reagan@example.com')
attendee7 = Attendee.create(event: event2, user: user2, name: 'Isaac', surname: 'Baraka', email: 'isaac@example.com')
